...
<body>
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form id="property-form" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="image-preview-container">
                        <?php for ($i = 1; $i <= 3; $i++): ?>
                            ...
                            <div class="image-preview">
                                ...
                                <button type="button" class="remove-btn" onclick="removeImage(<?php echo $i; ?>)">
                ...
                <?php if ($property_id > 0): ?>
                <a href="manage-property.php" class="btn" style="background: var(--medium-gray); margin-top: 10px; text-align: center; display: inline-block; text-decoration: none;">
    ...
    <div class="modal" id="successModal" style="display: flex;">
        <div class="modal-content">
            ...
            <button class="modal-btn" onclick="window.location.href='manage-property.php'">
